...
public class JhipsterMongoDbSampleApp {

    private static final Logger log = LoggerFactory.getLogger(JhipsterMongoDbSampleApp.class);

    private final Environment env;

    public JhipsterMongoDbSampleApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhipsterMongoDBSample.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipsterMongoDbSampleApp.class);
